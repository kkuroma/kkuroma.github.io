...
> **[Disclaimer]{color:primary}**: the events of this story happened in chronological order. For the best experience, read the chapters in order.
...
As expected, my laptop started to show its signs of age 2-3 years into its service. Years of abuse (overnight gaming and AI training... **[simultaneously!]{color:primary}**) messed up the battery to about 70% of its capacity. The laptop barely lasts 3 hours on idle, and that's with fans producing propeller engines level of noise. This was around the time both my lab and work issued organizational laptops (which were *MacBooks*), which became my daily driver when I'm outside. As I saw myself using my personal laptop more exclusively at home, I realized my hardware preferences were gradually changing... Portability is no longer a concern, and I wanted a strong machine build AI models locally, one I control, not the cloud.

# Chapter 2: The Invitation

My good friend [Haruto](https://harutohiroki.com) randomly texted me in the summer to help him move **[a box]{color:primary}**. *What box?* **[A literal server!]{color:primary}** Yes, the very servers CS majors ran \`sudo apt install\`. Apparently, [in his word](https://harutohiroki.com/blog.html#post/2026-goals), he was on a crusade to *[gain digital independence]{rainbow}* and combat *[corporate enshittification]{rainbow}*, something I've yet to understand at the time. Being a techstatic nerd that he is, Haruto immediately asked me if I wanted to buy the server he's returning. Considering my apartment's power and space constraint, and my *clear lack of reason* to own a server (a GPU less server isn't ideal for AI and games, I thought), I declined. Still, wanting a less spacious solution for my needs, Haruto recommended me to build a desktop PC around a great **[NVIDIA Tesla V100]{color:primary}** deal on ebay. I've used this GPU on the cloud to power many of my AI services, and so I accepted the offer, thinking it would be cool to finally run these heavy neural networks locally.

# Chapter 3: The Build

Haruto and I used [PCPartPickers](https://pcpartpicker.com) to plan out the mid-range build with the following parts:

- **[CPU]{color:primary}**: the mostly overlooked Ryzen 7 7700x (8 threads, 16 core). Overshadowed by the 7800x3D in pure gaming, the 7700x is a good budget option for a mix of gaming and productivity.
- **[RAM]{color:primary}**: a G.SKILL 32GB (16x2) DDR5 kit at 6000 cl36.
- **[Motherboard]{color:primary}**: Gigabyte X870 EAGLE WIFI7. It came with 3 PCIe slots, so we thought we could fit the V100 alongside a discrete gaming GPU. Little did we know, only one slot has the full 16 lanes.
- **[Storage]{color:primary}**: two 1TB Micron/Crucial Technology P310 NVMe PCIe SSDs.
...
What the hell?! Something is VERY wrong here. I tried all known "safe" methods under the sun. DDU, new driver versions, even reinstalling Windows doesn't help... I came to the unfortunate conclusion that something during the post-WSL reboot **[bricked the GPU's VBIOS]{color:primary}**, and it's no longer recognizable by any driver.
...
Everything seemed great, but still remember when I said I lost **[two]{color:primary}** silicon lotteries? Well, while my machine now works excellently in games (seeing my Minecraft FPS hits 4 digits was surreal) and AI (getting over 150 tokens/s on the new GPT-OSS 20b model), weird errors happened here and there:
...
I began scrolling Reddit's \`r/unixporn\` for inspiration. Among the many Linux distros, **[NixOS]{color:primary}** struck me the most profoundly for its declarative system configuration.
...
Wanting to try out NixOS myself, I installed NixOS to my SSD, only to be stuck with NVIDIA driver installation hurdles for hours. "Well let's boot back to Pop!OS and finish my work" **[WHICH POP!OS]{color:primary}** Turned out, I install NixOS based off the SSD's device name \`nvme0n1\`/\`nvme1n1\`, not knowing these are assigned on boot detection order, which is random. NixOS was installed on the SSD I had Pop!OS. As a day-old version of my data is backed up on my laptop, here are my options
...
First of all, 32GB of memory isn't going to cut hosting everything AND gaming simultaneously. Seeing as my old RAM modules are unstable with XMP/EXPO, I bought a 64GB kit of the same specs of DDR5 for \$200, a decision that would repay me greatly as **[the same RAM modules now costs \$800]{color:primary}**.
