...
- **[The "safeguard" can easily be circumvented by both children AND predators.]{color:green}** Fake (AI-generated) IDs are the easiest workaround to bypass age verification. While it's concerning if the children abuse such mechanics, the threat escalates tenfold when child predators can use the same loophole, pose as children, and be endorsed by the very child protection system to more easily talk to children.
